...
public class LoadbalancerTest {
    ...
    public void shouldAssignUserToGroups() throws Exception {
        ...
        Assert.assertEquals(4, groupCCount);
    }

    @Test
    public void shouldAssignUserToGroupsMaxDequeueSize() throws Exception {
        Queue<String> usersList = new LinkedList<>();
        String userId = "abc:1";
        String userId2 = "abc:2";
        String userId3 = "abc:3";
    ...
    @Test
    public void shouldAssignTheOnlyUserToTheHighestPercentageGroup() throws Exception {
        Queue<String> usersList = new LinkedList<>();
        String userId = "abc:1";
        usersList.add(userId);
        ...
        Assert.assertEquals(0, groupACount);
        Assert.assertEquals(0, groupBCount);
        Assert.assertEquals(1, groupCCount);
    }
